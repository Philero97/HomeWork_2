package ru.geekbrains.courses.java.HomeWork_8;
...
public class TicTacToeWisual extends JComponent {
    ...
    public static void main(String[] args) {
        ...
        TicTacToeWisual game = new TicTacToeWisual();
        window.add(game);
    }
